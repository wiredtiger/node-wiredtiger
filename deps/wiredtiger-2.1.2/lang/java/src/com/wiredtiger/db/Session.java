...
public class Session {
 ...
 protected static long getCPtr(Session obj) {
   ...
   */
  public  int create(String name, String config) {
   ...
   */
  public  int compact(String name, String config) {
   ...
   */
  public  int drop(String name, String config) {
   ...
   */
  public  int log_printf(String fmt) {
   ...
   */
  public  int rename(String uri, String newuri, String config) {
   ...
   */
  public  int salvage(String name, String config) {
   ...
   */
  public  int upgrade(String name, String config) {
   ...
   */
  public  int verify(String name, String config) {
   ...
   */
  public  int begin_transaction(String config) {
   ...
   */
  public  int commit_transaction(String config) {
   ...
   */
  public  int rollback_transaction(String config) {
   ...
   */
  public  int checkpoint(String config) {
